...
using MinRep.Client.Web;
using MinRep.Server.Services;
using System.Net;
...
public static partial class Program
{
    ...
    private static void AddSwaggerGen(WebApplicationBuilder builder)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "MinRep.Server.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "MinRep.Shared.xml"));
