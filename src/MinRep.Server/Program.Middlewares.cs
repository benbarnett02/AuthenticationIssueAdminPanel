...
public static partial class Program
{
    ...
    public static void ConfiureMiddlewares(this WebApplication app)
    {
        ...
        var blazorApp = app.MapRazorComponents<MinRep.Server.Components.App>()
            .AddInteractiveServerRenderMode()
            .AddInteractiveWebAssemblyRenderMode()
            .AddAdditionalAssemblies(AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("MinRep") is true).Except([Assembly.GetExecutingAssembly()]).ToArray());
